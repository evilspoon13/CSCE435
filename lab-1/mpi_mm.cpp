...
/**************************** worker task ************************************/
   if (taskid > MASTER)
   {
      ...
      // end time of worker sending process
   ...
   // Only workers participate in MPI_Reduce using worker_comm
   if (taskid > MASTER) {
